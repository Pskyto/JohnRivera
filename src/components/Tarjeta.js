...
const Card = ({loadingData, showData, weather, forecast}) => {
    ...
    return (
        <div className="mt-5" id="cardclima">

            {
                showData === true ? (
                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    {/* <img src="https://images.pexels.com/photos/10817264/pexels-photo-10817264.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" className="img img-fluid rounded-start" alt="..."/>    */}
                                </div>
                    ...
                    <h2 className="text-light">Consulta la Meteorología</h2>
                )
            }
